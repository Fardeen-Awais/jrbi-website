      ...
      <div class="w-full pt-4 pr-5 pb-6 pl-5 mt-0 mr-auto mb-0 ml-auto space-y-5 sm:py-8 md:py-12 sm:space-y-8 md:space-y-16
        ...
        <div class="grid grid-cols-12 sm:px-5 gap-x-8 gap-y-16">
          <div class="flex flex-col items-start col-span-12 space-y-3 sm:col-span-6 xl:col-span-4">
            ...
            <a class="text-lg font-bold sm:text-xl md:text-2xl">The brain itself cannot feel pain</a>
            <p class="text-sm text-black">Although pain is processed in the brain, the organ itself cannot feel pain. This is why brain surgeries can occur while a patient is awake, without discomfort. [Time]
...
As good as the brain is at turning short-term memories into long-term ones, it’s still important to keep those memories preserved for future generations. That’s why Legacybox helps you to digitize your memories - whether you have tapes, film, photos, or audio recordings, we’re here to help.</p>
            <div class="pt-2 pr-0 pb-0 pl-0">
