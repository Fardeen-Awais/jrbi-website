...
function Team({ author }) {
  ...
  return (
    <>
    <Head>
        <title>Rbi Team</title>
        <meta name="description" content="Check out our rbi team" />
        ...
        <div className="Appointment flex flex-col items-center justify-center p-5 m-10 md:m-28 gap-4">
          <div className="flex flex-col gap-5 justify-center items-center">
            ...
            <p className="text-center text-sm max-w-md md:max-w-lg">
              Our professional can help you with any questions you have.
              Schdeule your appointment today and have an meetup with us join
              our study program. Tell jolyce what should i write here lol
            </p>
          </div>
          <div className="flex">
            <Link href={"/chat"}>
                  ...
                  {({ open }) => (
                    <>
                      ...
                      <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm text-gray-500">
                        ...
                        email us within 90 days and well refund you in full, no
                        questions asked.
                      </Disclosure.Panel>
                    </>
                  )}
