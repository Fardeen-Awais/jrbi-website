  ...
  return (
        <div>
          <div className="grid grid-cols-1 gap-20 lg:grid-cols-2 lg:gap-10">
            <div className={`flex items-center flex-wrap max-w-md px-10 shadow-md rounded-2xl h-20 ${textColor}  font-semibold`}
               ...
               >
                  <div className="flex items-center justify-center -m-6 overflow-hidden bg-white rounded-full">
                    ...
                    <span className={`absolute text-2xl `} x-text="`${percent}%`">{score}</span>
                  </div>
                  <p className="ml-10  text-gray-600 ">Out of</p>

                  <span className={`mx-2 text-xl font-medium  `}>{totalQuestion}</span>
              </div>

            <div className={`flex items-center flex-wrap max-w-md px-10 shadow-md rounded-2xl h-20 ${textColor} text-3xl font-semibold`}
